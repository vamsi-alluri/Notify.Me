                ...
                public void run() {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            Log.e("Input",ttsMsg);
//                            processData(ttsMsg);
//                            FetchData process = new FetchData(ttsMsg);
//                            process.execute();
                            boolean flag = false;
                            try {
                                flag = waiting(ttsMsg);
...
//                            MonkeyLearnResponse res = process.getString();
//                            Log.i(TAG, "response ----------------"+ res);
//                            if(process.getcategory().equals("emergency")) {
                            Log.e("Emergency", String.valueOf(NotificationInfo.getemergency()));
                            if(flag){
                                speak(info);
                           }
//                            speak(info);
    ...
    public boolean waiting(String msg) throws ExecutionException, InterruptedException {
        FetchData process = new FetchData(msg);
        process.execute().get();
        return  NotificationInfo.getemergency();
    }
